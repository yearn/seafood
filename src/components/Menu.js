...
export default function Menu({action}) {
	...
	return <nav className={`
		fixed z-[100] top-0 w-full h-screen p-8
		...
		<ul className={'flex flex-col sm:flex-row justify-center'}>
			...
			{/* <MenuItem>
				<MenuLink to={'/masterchef'} label={'Masterchef'}></MenuLink>
			</MenuItem>
			<MenuItem>
				<MenuLink to={'/solidly'} label={'Solidly'}></MenuLink>
			</MenuItem> */}
			<MenuItem>
				<MenuLink to={'/sandbox'} label={'Sandbox'}></MenuLink>
			</MenuItem>
			{/* <MenuItem>
				<MenuLink to={'/settings'} label={'Settings'}></MenuLink>
			</MenuItem> */}
			<MenuItem>
