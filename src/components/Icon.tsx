...
export default function Icon({onClick, strokeWidth = 32, className}: {onClick?: () => void, strokeWidth?: number, className?: string}) {
	return <svg xmlns="http://www.w3.org/2000/svg" onClick={onClick} className={className} viewBox="0 0 512 512">
		...
		<path fill="none" stroke="url(#underTheSea)" strokeWidth={strokeWidth} strokeLinecap="round" strokeMiterlimit="20" d="M378.37,356a199.22,199.22,0,0,1,0-200"/>
	</svg>;
}